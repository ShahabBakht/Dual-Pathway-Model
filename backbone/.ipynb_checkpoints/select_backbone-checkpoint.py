...
def select_mousenet():
    ...
    net = network.load_network_from_pickle('/network/home/bakhtias/Project-Codes/Mouse_CNN/example/network_(3,64,64).pkl')
    model = mousenet.MouseNet(net)   
   param['output_area_list'] = ['VISp5', 'VISl5', 'VISrl5', 'VISli5', 'VISpl5', 'VISal5', 'VISpor5']
