...
if __name__ == '__main__':
    ...
    main_CatCam(f_root=F, 
            splits_root=S)
    # F = os.getenv('SLURM_TMPDIR') + '/UCF101_full/frame'
    # S = os.getenv('SLURM_TMPDIR') + '/UCF101_full/splits_classification'
#     F = '/network/tmp1/bakhtias/UCF101_full/UCF101_full/frame'
#     S = '/network/tmp1/bakhtias/UCF101_full/UCF101_full/splits_classification'
